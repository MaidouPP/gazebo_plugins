...
namespace gazebo
{
  ...
  private:
    ...
    /// \brief Previous target location
    ignition::math::Vector3d prevTarget;

    ignition::math::Vector3d startPos;

    /// \brief Within this radius, consider already reaching the target
    double targetRadius = 0.2;
    ...
    common::PoseAnimation *cornerAnimation{nullptr};
  };
}
#endif
